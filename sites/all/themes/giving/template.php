 ...
 * folder, Drush will think it is trying to giving core when it is invoked
 ...
 * @see _giving_theme()
 */
function giving_theme(&$existing, $type, $theme, $path) {
  giving_include($theme, 'theme/registry.inc');
  return _giving_theme($existing, $type, $theme, $path);
}
 ...
 */
giving_include('giving', 'theme/alter.inc');
