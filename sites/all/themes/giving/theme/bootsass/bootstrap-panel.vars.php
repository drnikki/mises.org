...
/**
 * Implements hook_preprocess_giving_panel().
 */
function giving_preprocess_giving_panel(&$variables) {
...
/**
 * Implements hook_process_giving_panel().
 */
function giving_process_giving_panel(&$variables) {
