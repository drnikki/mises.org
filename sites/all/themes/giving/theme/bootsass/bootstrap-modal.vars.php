...
/**
 * Implements theme_preprocess_giving_modal().
 *
 * @todo: Replace with "giving_effect_fade" theme setting.
 */
function giving_preprocess_giving_modal(&$variables) {
...
/**
 * Implements theme_process_giving_modal().
 */
function giving_process_giving_modal(&$variables) {
