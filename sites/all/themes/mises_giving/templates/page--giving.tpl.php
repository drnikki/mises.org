  ...
  <div id="page" class="<?php print $classes; ?>">
    ...
    <?php if ($title || $page['secondary_content']): ?>
      <div id="secondary-content-wrapper">
        <div class="container clearfix">
          <div <?php print (!$page['secondary_aside'] ? 'class="secondary-inner"' : 'class="secondary-inner secondary-left"'); ?>>
            <div class="title-bar">
              <?php if ($title): ?>
          ...
          <?php if ($page['secondary_aside']): ?>
            <?php print render($page['secondary_aside']); ?>
          <?php endif; ?>
        </div>
      </div>
    <?php endif; ?>
